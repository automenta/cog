# Crystallize a new implementation
- Add missing features that would enhance versatility for general-purpose applications
...
- Consider renaming identifiers
  - concise but accurate
  - easy-to-remember
  - lowest-level descriptors
  - to maximize modularity and potential extensibliity
...
- Deduplicated (no redundant logic) - introduce helpful abstractions to share code
...
Intelligence is defined as the capacity to adapt under insufficient knowledge and resources. Concretely, an intelligent system should be finite and open, and should work in real time.
