# Distill and recrystallize a new iteration of Cog.java
- Enable complete Hyperon/Prolog-like programming system ("Hyperon" is documented below) and leverage it for system dynamics
- Granularize the reasoning activity for precise online self-optimization
- Retain all Cog.java features, in some form
- Enable rule metaprogramming, homoiconicity, and reflectivity
- Enable dynamic rule generation, modification, adaptation, evolution
- Recursively, metaprogrammatically, dynamically, and hierarchically integrate and unify the system's functionality and knowledge ('elegant dogfooding')
- Refactor to enhance code quality
- Apply diverse insights from computer science and math to architect the ideal algorithms, data structures, and abstractions
    * unify and simplify
    * enable extensibility
    * maximize algorithmic and cognitive power
    * maximize system functionality
    * maximize efficiency (memory and speed)
    * maximize mathematical robustness and stability 
...
- Deduplicated (no redundant logic) - introduce helpful abstractions functions, parameters, and classes to share common code
- Modular (logically organized, supporting abstraction)
- Self-documenting (uses clear naming and structure, few-to-none comments; comment ONLY when code isn't obvious)
